...
class Optimizer(object):
    ...
    def __init__(self,
       ...
       Args:
        ...
        self._decay_step = 1
        self._reset_cycle_steps = reset_cycle_steps
    ...
    def from_opt(cls, model, opt, checkpoint=None):
        ...
        optimizer = cls(
            ...
            reset_cycle_steps=optim_opt.reset_cycle_steps)
        if optim_state_dict:
    ...
    def step(self):
        ...
        self._decay_step += 1
        self._training_step += 1
        if (self._reset_cycle_steps != 0) and (self._training_step % self._reset_cycle_steps == 0):
